...
export default {
    addStory:(story)=>axios.post("/v1/Stories/story",story).then(response=>response.data),
    updateStory:(story)=>axios.put("/v1/Stories/story",story).then(response=>response.data),
    ...
    deleteStory:(storyId)=>axios.delete(`/v1/Stories/story/${storyId}`).then(response=>response.data)
